...
//        private readonly ContactType _kind;
...
//        // ctor 2
//        public NewContactWin(ContactType kind) : this()
//        {
...
//        private void ShowGroupsForKind(ContactType kind)
//        {
//            employeeGroup.Visible = (kind == ContactType.Employee); /*|| kind == ContactKind.Trainee);*/
//            //traineeGroup.Visible = (kind == ContactType.Trainee);
//            customerGroup.Visible = (kind == ContactType.Customer);
//        }
//        /*
...
//                CmbCustomerType.Text = cust.CustomerType.ToString() ?? "";
